...
static anna_object_t *anna_node_string_literal_wrapper_i_init(anna_object_t **param)
{
    ...
    *(anna_node_t **)anna_member_addr_get_mid(
	param[0],ANNA_MID_NODE_PAYLOAD)=anna_node_string_literal_create(
	    &source->location,
...
void anna_node_string_literal_wrapper_type_create(anna_stack_frame_t *stack)
{
    anna_node_t *argv[] = 
	{
	    (anna_node_t *)anna_node_identifier_create(0, L"StringLiteral"),
