...
{
    anna_type_data_make(object_type, L"Object"),
    anna_type_data_make(null_type,L"Null" ),
    anna_type_data_make(int_type,L"Int" ),
    anna_type_data_make(any_list_type,L"List" ),
    anna_type_data_make(imutable_list_type,L"ImutableList" ),
    anna_type_data_make(mutable_list_type, L"MutableList" ),
    anna_type_data_make(string_type, L"String" ),
    anna_type_data_make(imutable_string_type, L"ImutableString" ),
    anna_type_data_make(mutable_string_type, L"MutableString" ),
    anna_type_data_make(float_type, L"Float" ),
    anna_type_data_make(complex_type, L"Complex" ),
    anna_type_data_make(char_type, L"Char" ),
    anna_type_data_make(range_type, L"Range" ),
    anna_type_data_make(hash_type, L"HashMap" ),
    anna_type_data_make(pair_type, L"Pair" ),
    anna_type_data_make(buffer_type, L"Buffer" ),
    anna_type_data_make(sendable_type, L"Sendable" ),
};
