...
for i in "gt >" "lt <" "eq ==" "gte >=" "lte <=" "neq !="; do
    ...
    init="$init
    anna_native_method_create(char_type, -1, L\"__${name}Char__\", 0, (anna_native_t)&anna_char_i_${name}, char_type, 2, c_argv, argn);"
...
for i in "add +" "sub -"; do
    ...
    init="$init
    anna_native_method_create(char_type, -1, L\"__${name}Int__\", 0, (anna_native_t)&anna_char_i_${name}, char_type, 2, i_argv, argn);"
