...
static void anna_int_type_i_create()
{
	...
	int_type, anna_mid_get(L"__add__Int__"), 0, 
	&anna_int_i_add, 
	int_type,
	2, argv, argn, 0, 0);
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__increaseAssign__Int__"), 0, 
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__sub__Int__"), 0, 
	&anna_int_i_sub, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__decreaseAssign__Int__"), 0, 
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__mul__Int__"), 0, 
	&anna_int_i_mul, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__div__Int__"), 0, 
	&anna_int_i_div, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__mod__Int__"), 0, 
	&anna_int_i_mod, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__bitand__Int__"), 0, 
	&anna_int_i_bitand, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__bitor__Int__"), 0, 
	&anna_int_i_bitor, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__bitxor__Int__"), 0, 
	&anna_int_i_bitxor, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__exp__Int__"), 0, 
	&anna_int_i_exp, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__shl__Int__"), 0, 
	&anna_int_i_shl, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
    ...
    mmid = anna_member_create_native_method(
	int_type, anna_mid_get(L"__shr__Int__"), 0, 
	&anna_int_i_shr, 
	int_type,
	2, argv, argn, 0, 0);
    fun = anna_function_unwrap(anna_as_obj_fast(anna_entry_get_static(int_type, mmid)));
	...
	int_type, anna_mid_get(L"__abs__"), 0, 
	&anna_int_i_abs, 
	int_type,
	1, argv, argn, 0, 0);

    anna_member_create_native_method(
	int_type, anna_mid_get(L"__neg__"), 0, 
	&anna_int_i_neg, 
	int_type,
	1, argv, argn, 0, 0);

    anna_member_create_native_method(
	int_type, anna_mid_get(L"__sign__"), 0, 
	&anna_int_i_sign, 
	int_type,
	1, argv, argn, 0, 0);
    ...
    anna_member_create_native_method(
	int_type, anna_mid_get(L"__nextAssign__"), 0, 
	&anna_int_i_nextAssign, 
	int_type,
	1, argv, argn, 0, 0);

    anna_member_create_native_method(
	int_type, anna_mid_get(L"__prevAssign__"), 0, 
