static inline anna_entry_t *anna_node_float_literal_wrapper_i_get_payload_i(anna_entry_t **param)
{
...
static inline anna_entry_t *anna_node_float_literal_wrapper_i_init_i(anna_entry_t **param)
{
    anna_object_t *this = anna_as_obj_fast(param[0]);
...
static anna_type_t *anna_node_create_float_literal_wrapper_type(anna_stack_template_t *stack)
{
